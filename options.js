function fillOptions() {
  chrome.storage.sync.get(["apiKey", "model", "promptChinese", "promptEnglish", "bubbleTimeout", "useAPI"], (result) => {
    if (result.apiKey) {
...
function saveOptions() {
  ...
  chrome.storage.sync.set({ apiKey, model, promptChinese, promptEnglish, bubbleTimeout, useAPI }, () => {
